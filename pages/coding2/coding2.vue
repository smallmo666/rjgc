	...
	<view class="content">
		<view class="top-bar">
			...
			<view class="top-bar-right">
				...
				<view class="add"><image src="../../static/image/element/add.jpg"></image></view>
			</view>
		</view>
		<view class="main">
			<view class="question">
				<scroll-view class="qustitle" scroll-y="true" scroll-with-animation="true":scroll-into-view="scrollToView">
				<p v-html=title></p>
				</scroll-view>				
				<scroll-view class="quscontent" scroll-y="true" scroll-with-animation="true":scroll-into-view="scrollToView">
				<p v-html=content></p>
				</scroll-view>
			</view>
			<view class="code">
...
import datas from "../../common/js/data.js"
	...
	export default {
		...
		methods: {
			...
			//获取面试官信息
			receiveSocketId:function(){	
				this.socket.on('init',(uid,reid,name,title,content)=>{
					this.title=title;
					this.rename=name;
